# Generated by Django 4.2.27 on 2026-05-22 14:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            code=cargar_documentaciones,
            reverse_code=borrar_documentaciones,
        ),
        migrations.AddField(
            model_name="archivoorganizacion",
            name="numero_gde",
            field=models.CharField(
                blank=True, max_length=50, null=True, verbose_name="Numero de GDE"
            ),
        ),
    ]
