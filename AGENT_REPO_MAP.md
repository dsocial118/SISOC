...
| `pas/` | núcleo del Programa de Acompañamiento Social: titulares, estados, avisos e historial; contrato público en `pas/api.py` | `models.py`, `api.py`, `services/resumen_publico_service.py`, `migrations/` | Alto |
