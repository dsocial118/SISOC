...
| `pas/` | núcleo del Programa de Acompañamiento Social y circuito DDJJ: padrón, tokens, formulario público, PDF e importación CSV | `models.py`, `api.py`, `services/ddjj_service.py`, `services/titulares_import_service.py`, `urls.py`, `migrations/` | Alto |
