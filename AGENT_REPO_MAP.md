...
| `pas/` | núcleo del Programa de Acompañamiento Social, circuito DDJJ e Informes PAS versionados | `models.py`, `api.py`, `services/ddjj_service.py`, `services/titulares_import_service.py`, `services/informe_service.py`, `urls.py`, `migrations/` | Alto |
