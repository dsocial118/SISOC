    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dimension', models.CharField(choices=[(None, ''), ('Familia', 'Familia'), ('Vivienda', 'Vivienda'), ('Salud', 'Salud'), ('Economía', 'Economía'), ('Educación', 'Educación'), ('Trabajo', 'Trabajo')], default='Desconocida', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=255, unique=True)),
                ('dimension', models.CharField(blank=True, choices=[(None, ''), ('Familia', 'Familia'), ('Vivienda', 'Vivienda'), ('Salud', 'Salud'), ('Economía', 'Economía'), ('Educación', 'Educación'), ('Trabajo', 'Trabajo')], max_length=255, null=True)),
                ('estado', models.BooleanField(default=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=255, unique=True)),
                ('tipo', models.CharField(choices=[(None, ''), ('Hospital', 'Hospital'), ('CAP', 'CAP'), ('Escuela', 'Escuela'), ('Club Barrial', 'Club Barrial'), ('ONG/Agrupación Comunitaria', 'ONG/Agrupación Comunitaria'), ('Organismo Municipal', 'Organismo Municipal'), ('Organismo Provincial', 'Organismo Provincial'), ('Organismo Nacional', 'Organismo Nacional')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=255, unique=True)),
                ('jurisdiccion', models.CharField(choices=[(None, ''), ('Nacional', 'Nacional'), ('Provincial', 'Provincial'), ('Municipal', 'Municipal')], max_length=255)),
                ('estado', models.BooleanField(default=True)),
                ('observaciones', models.CharField(blank=True, max_length=500, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=255)),
                ('observaciones', models.CharField(blank=True, max_length=500, null=True)),
                ('manianabb', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Turno Mañana')),
                ('tardebb', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Turno Tarde')),
                ('maniana2', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Turno Mañana')),
                ('tarde2', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Turno Tarde')),
                ('maniana3', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Turno Mañana')),
                ('tarde3', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Turno Tarde')),
                ('maniana4', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Turno Mañana')),
                ('tarde4', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Turno Tarde')),
                ('estado', models.BooleanField(default=True)),
        ...
        migrations.AddIndex(
            model_name='alertas',
            index=models.Index(fields=['fk_categoria'], name='configuraci_fk_cate_e4ddce_idx'),
        ),
        migrations.AddIndex(
            model_name='alertas',
            index=models.Index(fields=['gravedad'], name='configuraci_graveda_d5db37_idx'),
        ),
    ]
