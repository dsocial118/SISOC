...
def backfill_excel_masivo_audit(apps, _schema_editor):
    ...
    for expediente in expedientes.iterator():
        ...
        if historial_procesado:
            update_data["excel_masivo_procesado_por_id"] = historial_procesado.usuario_id
...
class Migration(migrations.Migration):
    ...
    replaces = [('celiaquia', '0001_initial'), ('celiaquia', '0002_expediente_numero_expediente_and_more'), ('celiaquia', '0003_expedienteciudadano_estado_validacion_renaper_and_more'), ('celiaquia', '0004_registroerroneo'), ('celiaquia', '0005_add_rol_and_new_models'), ('celiaquia', '0006_remove_registroerroneoreprocesado_celiaquia_registroerroneoreprocesado_unique_and_more'), ('celiaquia', '0007_documentolegajo_historialcomentarios_tipodocumento_and_more'), ('celiaquia', '0008_alter_asignaciontecnico_managers_and_more'), ('celiaquia', '0009_add_subsanacion_tipo'), ('celiaquia', '0010_expediente_soft_delete_fields'), ('celiaquia', '0011_alter_expediente_managers'), ('celiaquia', '0012_expediente_excel_masivo_audit')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excel_masivo', models.FileField(blank=True, null=True, upload_to='expedientes/masivos/')),
                ('cruce_excel', models.FileField(blank=True, null=True, upload_to='expedientes/cruces/')),
                ('documento', models.FileField(blank=True, null=True, upload_to='expedientes/prd/')),
                ('estado', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='expedientes', to='celiaquia.estadoexpediente')),
                ('usuario_modificador', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='expedientes_modificados', to=settings.AUTH_USER_MODEL)),
                ('usuario_provincia', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='expedientes_creados', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('archivo1', models.FileField(blank=True, null=True, upload_to='legajos/archivos/')),
                ('archivo2', models.FileField(blank=True, null=True, upload_to='legajos/archivos/')),
                ('archivo3', models.FileField(blank=True, null=True, upload_to='legajos/archivos/')),
                ...
                ('ciudadano', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='expedientes', to='ciudadanos.ciudadano')),
                ('estado', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='expediente_ciudadanos', to='celiaquia.estadolegajo')),
                ('expediente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expediente_ciudadanos', to='celiaquia.expediente')),
                ('subsanacion_usuario', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subsanaciones_realizadas', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('periodo', models.CharField(db_index=True, help_text='YYYY-MM', max_length=7)),
                ('estado', models.CharField(choices=[('BORRADOR', 'Borrador'), ('ENVIADO', 'Enviado a Sintys'), ('PROCESADO', 'Cruce procesado'), ('CERRADO', 'Cerrado')], default='BORRADOR', max_length=12)),
                ('archivo_envio', models.FileField(blank=True, null=True, upload_to='pagos/envios/')),
                ('archivo_respuesta', models.FileField(blank=True, null=True, upload_to='pagos/respuestas/')),
                ...
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='pagos_modificados', to=settings.AUTH_USER_MODEL)),
                ('provincia', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='pagos_expedientes', to='core.provincia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provincia', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='cupo', to='core.provincia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observaciones', models.TextField(blank=True, null=True)),
                ('estado_anterior', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='celiaquia.estadoexpediente')),
                ('estado_nuevo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='celiaquia.estadoexpediente')),
                ('expediente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historial', to='celiaquia.expediente')),
                ('usuario', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cambios_estado', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('ALTA', 'Alta'), ('REACTIVACION', 'Reactivacion'), ('BAJA', 'Baja'), ('AJUSTE', 'Ajuste'), ('SUSPENDIDO', 'Suspendido')], max_length=20)),
                ('delta', models.IntegerField()),
                ('motivo', models.CharField(blank=True, max_length=255)),
                ('creado_en', models.DateTimeField(auto_now_add=True)),
                ('expediente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='movimientos_cupo', to='celiaquia.expediente')),
                ('legajo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='movimientos_cupo', to='celiaquia.expedienteciudadano')),
                ('provincia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movimientos_cupo', to='core.provincia')),
                ('usuario', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='movimientos_cupo', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expediente', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='asignacion_tecnico', to='celiaquia.expediente')),
                ('tecnico', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='expedientes_asignados', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('VALIDADO', 'Validado para pago'), ('EXCLUIDO', 'Excluido por cruce')], default='VALIDADO', max_length=12)),
                ('observacion', models.CharField(blank=True, max_length=255)),
                ('creado_en', models.DateTimeField(auto_now_add=True)),
                ('legajo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='pagos', to='celiaquia.expedienteciudadano')),
                ('pago', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nomina', to='celiaquia.pagoexpediente')),
            ],
            options={
                'verbose_name': 'Fila nómina de pago',
                'verbose_name_plural': 'Nómina de pago',
                'indexes': [models.Index(fields=['pago', 'estado'], name='pago_nomina_estado_idx'), models.Index(fields=['documento'], name='pago_nomina_doc_idx')],
                'unique_together': {('pago', 'legajo')},
            },
        ),
        migrations.AddIndex(
            model_name='pagoexpediente',
            index=models.Index(fields=['provincia', 'periodo', 'estado'], name='pago_prov_per_estado_idx'),
        ),
        migrations.AddIndex(
            model_name='expedienteciudadano',
            index=models.Index(fields=['expediente', 'revision_tecnico'], name='leg_exp_rev_idx'),
        ),
        migrations.AddIndex(
            model_name='expedienteciudadano',
        ...
        migrations.AddIndex(
            model_name='expedienteciudadano',
            index=models.Index(fields=['expediente', 'estado_cupo'], name='leg_exp_cupo_idx'),
        ),
        migrations.AddIndex(
            model_name='expedienteciudadano',
            index=models.Index(fields=['expediente', 'resultado_sintys'], name='leg_exp_sin_idx'),
        ),
        migrations.AddIndex(
            model_name='expedienteciudadano',
            index=models.Index(fields=['expediente', 'es_titular_activo'], name='leg_exp_tit_idx'),
        ),
        migrations.AddIndex(
            model_name='expedienteciudadano',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['usuario_provincia', 'estado'], name='exp_prov_est_idx'),
        ),
        migrations.AddIndex(
            model_name='expediente',
            index=models.Index(fields=['estado', 'fecha_creacion'], name='exp_est_fecha_idx'),
        ),
        migrations.AddIndex(
            model_name='expediente',
            index=models.Index(fields=['usuario_provincia', 'fecha_creacion'], name='exp_prov_fecha_idx'),
        ),
        migrations.AddIndex(
            model_name='expediente',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['provincia', '-creado_en'], name='cupo_prov_fecha_idx'),
        ),
        migrations.AddIndex(
            model_name='cupomovimiento',
            index=models.Index(fields=['expediente', '-creado_en'], name='cupo_exp_fecha_idx'),
        ),
        migrations.AddIndex(
            model_name='cupomovimiento',
            index=models.Index(fields=['legajo', '-creado_en'], name='cupo_leg_fecha_idx'),
        ),
        migrations.AddIndex(
            model_name='cupomovimiento',
            index=models.Index(fields=['tipo', 'provincia', '-creado_en'], name='cupo_tipo_prov_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AlterField(
            model_name='asignaciontecnico',
            name='expediente',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='asignaciones_tecnicos', to='celiaquia.expediente'),
        ),
        migrations.AlterUniqueTogether(
            name='asignaciontecnico',
        ...
        migrations.AddIndex(
            model_name='expedienteciudadano',
            index=models.Index(fields=['estado_cupo', 'es_titular_activo'], name='leg_cupo_activo_idx'),
        ),
        migrations.AddIndex(
            model_name='expedienteciudadano',
            index=models.Index(fields=['revision_tecnico', 'resultado_sintys'], name='leg_rev_sintys_idx'),
        ),
        migrations.AddField(
            model_name='expedienteciudadano',
            name='estado_validacion_renaper',
            field=models.IntegerField(db_index=True, default=0, help_text='0=no validado, 1=aceptado, 2=rechazado, 3=subsanar'),
        ),
        migrations.AddField(
            model_name='expedienteciudadano',
            name='subsanacion_renaper_archivo',
            field=models.FileField(blank=True, help_text='Archivo de respuesta a subsanación Renaper', null=True, upload_to='legajos/subsanacion_renaper/'),
        ),
        migrations.AddField(
            model_name='expedienteciudadano',
            name='subsanacion_renaper_comentario',
            field=models.TextField(blank=True, help_text='Comentario de respuesta a subsanación Renaper', null=True),
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ('fila_excel',),
                'indexes': [models.Index(fields=['expediente', 'procesado'], name='reg_err_exp_proc_idx')],
            },
        ),
        migrations.AddField(
            model_name='expedienteciudadano',
            name='rol',
            field=models.CharField(choices=[('beneficiario', 'Solo Beneficiario'), ('responsable', 'Solo Responsable'), ('beneficiario_y_responsable', 'Beneficiario y Responsable')], db_index=True, default='beneficiario', max_length=50),
        ),
        migrations.AddIndex(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_comentario', models.CharField(choices=[('VALIDACION_TECNICA', 'Validación Técnica'), ('SUBSANACION_MOTIVO', 'Motivo de Subsanación'), ('SUBSANACION_RESPUESTA', 'Respuesta de Subsanación'), ('RENAPER_VALIDACION', 'Validación RENAPER'), ('OBSERVACION_GENERAL', 'Observación General'), ('CRUCE_SINTYS', 'Cruce SINTYS'), ('PAGO_OBSERVACION', 'Observación de Pago')], db_index=True, max_length=30)),
                ('comentario', models.TextField()),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('archivo_adjunto', models.FileField(blank=True, null=True, upload_to='comentarios/')),
                ('estado_relacionado', models.CharField(blank=True, help_text='Estado del legajo al momento del comentario', max_length=50, null=True)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='legajo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historial_comentarios', to='celiaquia.expedienteciudadano'),
        ),
        migrations.AddField(
            model_name='historialcomentarios',
            name='usuario',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='comentarios_realizados', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='documentolegajo',
            name='legajo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documentos', to='celiaquia.expedienteciudadano'),
        ),
        migrations.AddField(
            model_name='documentolegajo',
            name='tipo_documento',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='documentos_legajo', to='celiaquia.tipodocumento'),
        ),
        migrations.AddField(
            model_name='documentolegajo',
            name='usuario_carga',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='documentos_cargados', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddIndex(
            model_name='historialcomentarios',
            index=models.Index(fields=['legajo', '-fecha_creacion'], name='celiaquia_h_legajo__123fc8_idx'),
        ),
        migrations.AddIndex(
            model_name='historialcomentarios',
            index=models.Index(fields=['tipo_comentario', '-fecha_creacion'], name='celiaquia_h_tipo_co_558cb7_idx'),
        ),
        migrations.AddIndex(
            model_name='historialcomentarios',
            index=models.Index(fields=['usuario', '-fecha_creacion'], name='celiaquia_h_usuario_989d09_idx'),
        ),
        migrations.AddIndex(
            model_name='documentolegajo',
            index=models.Index(fields=['legajo', 'tipo_documento'], name='celiaquia_d_legajo__194cb5_idx'),
        ),
        migrations.AddIndex(
            model_name='documentolegajo',
            index=models.Index(fields=['fecha_carga'], name='celiaquia_d_fecha_c_023657_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='documentolegajo',
