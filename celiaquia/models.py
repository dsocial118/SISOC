...
class ExpedienteCiudadano(models.Model):
    ...
    def agregar_comentario(self, tipo_comentario, comentario, usuario=None, archivo_adjunto=None):
    ...
    def documentos_faltantes(self):
        ...
        tipos_cargados = self.documentos.values_list(
...
class AsignacionTecnico(models.Model):
    ...
    activa = models.BooleanField(default=True, help_text="Indica si la asignación está activa")
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["expediente", "activa"], name="asig_expediente_activa_idx"),
        ]
