...
class DocumentosService:
    ...
    @staticmethod
    def verificar_documentos_completos(legajo: ExpedienteCiudadano) -> tuple[bool, list]:
        """
    ...
    @staticmethod
    @transaction.atomic
    def eliminar_documento(legajo: ExpedienteCiudadano, tipo_documento_nombre: str, usuario: User = None):
    ...
    def obtener_tipos_documento_requeridos():
        ...
        return TipoDocumento.objects.filter(requerido=True, activo=True).order_by('orden')