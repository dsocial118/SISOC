...
def obtener_historial_comentarios(request, legajo_id):
    ...
    for comentario in comentarios:
        data.append({
            ...
            'usuario': comentario.usuario.username if comentario.usuario else 'Sistema',
...
def obtener_comentarios_por_tipo(request, legajo_id, tipo_comentario):
    ...
    tipos_validos = [choice[0] for choice in HistorialComentarios.TIPO_COMENTARIO_CHOICES]
