...
class ExpedientePago(models.Model):
    expediente_pago = models.CharField(max_length=255, verbose_name="Expediente de Pago")
    resolucion_pago = models.CharField(max_length=255, verbose_name="Resolución de Pago")
    anexo = models.CharField(max_length=255, verbose_name="Anexo")
    if_cantidad_de_prestaciones = models.IntegerField(verbose_name="IF Cantidad de Prestaciones")
    if_pagado = models.BooleanField(default=False, verbose_name="IF Pagado")
    monto = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Monto")
    numero_orden_pago = models.CharField(max_length=255, verbose_name="Número de Orden de Pago")
