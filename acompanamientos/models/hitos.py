...
class Hitos(models.Model):
    ...
    notificacion_acreditacion_2 = models.BooleanField(
        default=False, verbose_name="Notificación de acreditación mes 2"
    )
    notificacion_acreditacion_3 = models.BooleanField(
        default=False, verbose_name="Notificación de acreditación mes 3"
    )
    notificacion_acreditacion_4 = models.BooleanField(
        default=False, verbose_name="Notificación de acreditación mes 4"
    )
    notificacion_acreditacion_5 = models.BooleanField(
        default=False, verbose_name="Notificación de acreditación mes 5"
    )
    notificacion_acreditacion_6 = models.BooleanField(
        default=False, verbose_name="Notificación de acreditación mes 6"
    )
    nomina_entregada_inicial = models.BooleanField(
        default=False, verbose_name="Nómina entregada inicial"
    )
    nomina_alta_baja_2 = models.BooleanField(
        default=False, verbose_name="Nómina Alta/baja mes 2"
    )
    nomina_alta_baja_3 = models.BooleanField(
        default=False, verbose_name="Nómina Alta/baja mes 3"
    )
    nomina_alta_baja_4 = models.BooleanField(
        default=False, verbose_name="Nómina Alta/baja mes 4"
    )
    nomina_alta_baja_5 = models.BooleanField(
        default=False, verbose_name="Nómina Alta/baja mes 5"
    )
    nomina_alta_baja_6 = models.BooleanField(
        default=False, verbose_name="Nómina Alta/baja mes 6"
    )
    certificado_prestaciones_1 = models.BooleanField(
        default=False, verbose_name="Certificado mensual de prestaciones mes: 1"
    )
    certificado_prestaciones_2 = models.BooleanField(
        default=False, verbose_name="Certificado mensual de prestaciones mes: 2"
    )
    certificado_prestaciones_3 = models.BooleanField(
        default=False, verbose_name="Certificado mensual de prestaciones mes: 3"
    )
    certificado_prestaciones_4 = models.BooleanField(
        default=False, verbose_name="Certificado mensual de prestaciones mes: 4"
    )
    certificado_prestaciones_5 = models.BooleanField(
        default=False, verbose_name="Certificado mensual de prestaciones mes: 5"
    )
    certificado_prestaciones_6 = models.BooleanField(
        default=False, verbose_name="Certificado mensual de prestaciones mes: 6"
    )
