...
class AcompanamientoDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["hitos_config"] = [
            ...
            {'campo': 'alta_usuario_plataforma', 'descripcion': 'Alta de Usuario en Plataforma'},
            {'campo': 'capacitacion_realizada', 'descripcion': 'Capacitación realizada'},
            {'campo': 'notificacion_acreditacion_1', 'descripcion': 'Notificación de primera acreditación'},
            {'campo': 'notificacion_acreditacion_2', 'descripcion': 'Notificación de acreditación mes 2'},
            {'campo': 'notificacion_acreditacion_3', 'descripcion': 'Notificación de acreditación mes 3'},
            {'campo': 'notificacion_acreditacion_4', 'descripcion': 'Notificación de acreditación mes 4'},
            {'campo': 'notificacion_acreditacion_5', 'descripcion': 'Notificación de acreditación mes 5'},
            {'campo': 'notificacion_acreditacion_6', 'descripcion': 'Notificación de acreditación mes 6'},
            {'campo': 'nomina_entregada_inicial', 'descripcion': 'Nómina entregada inicial'},
            ...
            {'campo': 'certificado_prestaciones_1', 'descripcion': 'Certificado mensual de prestaciones mes: 1'},
            {'campo': 'certificado_prestaciones_2', 'descripcion': 'Certificado mensual de prestaciones mes: 2'},
            {'campo': 'certificado_prestaciones_3', 'descripcion': 'Certificado mensual de prestaciones mes: 3'},
            {'campo': 'certificado_prestaciones_4', 'descripcion': 'Certificado mensual de prestaciones mes: 4'},
            {'campo': 'certificado_prestaciones_5', 'descripcion': 'Certificado mensual de prestaciones mes: 5'},
            {'campo': 'certificado_prestaciones_6', 'descripcion': 'Certificado mensual de prestaciones mes: 6'},
        ]
