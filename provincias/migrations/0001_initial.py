# Generated by Django 4.0.2 on 2024-10-30 13:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anexo_formacion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='provincias.anexoformacion')),
                ('anexo_socio_productivo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='provincias.anexosocioproductivo')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='provincias.diagnosticoorganizacion'),
        ),
        migrations.AddField(
            model_name='anexosocioproductivo',
            name='diagnostico_persona',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='provincias.diagnosticopersona'),
        ),
        migrations.AddField(
            model_name='anexosocioproductivo',
            name='linea_de_accion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='provincias.lineadeaccion'),
        ),
        migrations.AddField(
            model_name='anexosocioproductivo',
            name='organizacion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='provincias.personeriaorganizacion'),
        ),
        migrations.AddField(
            model_name='anexosocioproductivo',
            name='persona',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='provincias.personeriapersona'),
        ),
    ]
