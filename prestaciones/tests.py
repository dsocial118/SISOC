...
class TestCreateView:
	...
	def test_post_creates_prestacion_and_sets_usuario_creador(self, client, user_in_group):
		client.login(username="user1", password="pass12345")
		payload = {
...
class TestDeleteView:
	...
	def test_delete_removes_and_redirects_with_message(self, client, prestacion, user_in_group):
		client.login(username="user1", password="pass12345")
