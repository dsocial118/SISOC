...
FILTER_FIELDS = [
    ...
    {"name": "vinculo_parental", "label": "Vínculo parental", "type": "text"},
    ...
    {"name": "prefijo_celular", "label": "Prefijo celular", "type": "text"},
    {"name": "numero_celular", "label": "Número celular", "type": "text"},
    {"name": "prefijo_telefono_fijo", "label": "Prefijo teléfono fijo", "type": "text"},
    {"name": "numero_telefono_fijo", "label": "Número teléfono fijo", "type": "text"},
