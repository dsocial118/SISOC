...
class CabalArchivo(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["fecha_subida"], name="vat_cabal_fecha_idx"),
            models.Index(fields=["nombre_original"], name="vat_cabal_nombre_idx"),
        ]
...
class InformeCabalRegistro(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["archivo"], name="vat_icr_archivo_idx"),
            models.Index(fields=["centro"], name="vat_icr_centro_idx"),
            models.Index(fields=["nro_comercio"], name="vat_icr_nrocom_idx"),
            models.Index(fields=["fecha_trx"], name="vat_icr_fechatrx_idx"),
        ]
...
class Responsable(SoftDeleteModelMixin, models.Model):
    ...
    prefijo_celular = models.CharField(null=True, blank=True, max_length=4)
    numero_celular = models.CharField(null=True, blank=True, max_length=12)
    prefijo_telefono_fijo = models.CharField(null=True, blank=True, max_length=4)
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                ...
                name="vat_unique_dni_genero_tipo",
            )
        ]
