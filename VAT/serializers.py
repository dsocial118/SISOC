...
from VAT.models import (
    ...
    ParticipanteActividad, ParticipanteActividadHistorial,
    Beneficiario, Responsable, BeneficiarioResponsable,
    CabalArchivo, InformeCabalRegistro,
)
...
class ActividadCentroSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "centro", "centro_nombre", "actividad", "actividad_nombre",
            "cantidad_personas", "dias", "dias_nombres",
            "horariosdesde", "horarioshasta", "precio", "estado",
        ]


class CentroSerializer(serializers.ModelSerializer):
    referente_nombre = serializers.CharField(source="referente.get_full_name", read_only=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            "apellido_referente", "categorias_actividades",
        ]
...
class ResponsableSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Responsable
        fields = [
            "id", "vinculo_parental", "cuil", "dni", "apellido", "nombre",
            "genero", "fecha_nacimiento", "provincia", "provincia_nombre",
            "municipio", "municipio_nombre", "localidad", "localidad_nombre",
            "calle", "altura", "correo_electronico", "numero_celular",
        ]
...
class BeneficiarioSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Beneficiario
        fields = [
            "id", "cuil", "dni", "apellido", "nombre", "genero",
            "fecha_nacimiento", "domicilio", "provincia", "provincia_nombre",
            "municipio", "municipio_nombre", "localidad", "localidad_nombre",
            "nivel_educativo_actual", "maximo_nivel_educativo",
            "responsable", "responsable_nombre",
            "actividad_preferida", "actividades_extracurriculares",
        ]


class BeneficiarioResponsableSerializer(serializers.ModelSerializer):
    beneficiario_nombre = serializers.CharField(source="beneficiario.get_full_name", read_only=True)
    responsable_nombre = serializers.CharField(source="responsable.get_full_name", read_only=True)

    class Meta:
        model = BeneficiarioResponsable
        fields = [
            "id", "beneficiario", "beneficiario_nombre",
            "responsable", "responsable_nombre", "vinculo_parental",
        ]
...
class ParticipanteActividadHistorialSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "estado_anterior", "estado_nuevo", "fecha_cambio", "usuario", "usuario_nombre"]


class ParticipanteActividadSerializer(serializers.ModelSerializer):
    ciudadano_nombre = serializers.CharField(source="ciudadano.get_full_name", read_only=True)
    actividad_nombre = serializers.CharField(source="actividad_centro.actividad.nombre", read_only=True)
    historial = ParticipanteActividadHistorialSerializer(many=True, read_only=True)

    class Meta:
        model = ParticipanteActividad
        fields = [
            "id", "actividad_centro", "actividad_nombre", "ciudadano",
            "ciudadano_nombre", "estado", "fecha_registro", "fecha_modificacion", "historial",
        ]
...
class InformeCabalRegistroSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "centro", "centro_nombre", "nro_tarjeta", "nro_auto",
            "nro_comercio", "razon_social", "importe", "fecha_trx",
            "no_coincidente", "fila_numero",
        ]
...
class CabalArchivoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CabalArchivo
        fields = [
            "id", "nombre_original", "usuario", "usuario_nombre", "fecha_subida",
            "total_filas", "total_validas", "total_invalidas", "registros",
        ]
