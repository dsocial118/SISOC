...
class ParticipanteActividadCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = "vat/centros/participanteactividad_form.html"
    ...
    def get_success_url(self):
        return reverse_lazy(
            ...
            kwargs={"pk": self.kwargs.get("actividad_id")},
        )
...
class ParticipanteActividadDeleteView(LoginRequiredMixin, View):
    template_name = "vat/centros/participanteactividad_confirm_delete.html"
...
class ParticipanteActividadListEsperaView(LoginRequiredMixin, ListView):
    model = ParticipanteActividad
    template_name = "vat/centros/participanteactividad_lista_espera.html"
