...
urlpatterns = [
    ...
    path('administracion/password-reset/done/', auth_views.PasswordResetDoneView.as_view(template_name='Passwords/password_reset_done.html'),name='password_reset_done'),
    path('administracion/password-reset-confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='Passwords/password_reset_confirm.html',form_class =MySetPasswordFormm),name='password_reset_confirm'),
    path('administracion/password-reset-complete/',auth_views.PasswordResetCompleteView.as_view(template_name='Passwords/password_reset_complete.html'),name='password_reset_complete'),
