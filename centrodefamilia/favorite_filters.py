...
from centrodefamilia.services.beneficiarios_filter_config import (  # pylint: disable=no-name-in-module
...
from centrodefamilia.services.centro_filter_config import (  # pylint: disable=no-name-in-module
...
from centrodefamilia.services.responsables_filter_config import (  # pylint: disable=no-name-in-module
