...
class GenerarUsuarioCDFForm(forms.Form):
    """Datos del usuario "CDF - Referente centro" a generar.

    El grupo es fijo y no se expone como campo (lo asigna el servicio). Los
    campos se precargan con los datos del responsable ya cargado en el Centro.
    """
