...
router.register(r"actividades-centro", ActividadCentroViewSet, basename="api-actividad-centro")
router.register(r"participantes", ParticipanteActividadViewSet, basename="api-participante")
...
router.register(r"beneficiario-responsable", BeneficiarioResponsableViewSet, basename="api-beneficiario-responsable")
router.register(r"cabal-registros", InformeCabalRegistroViewSet, basename="api-cabal-registro")
