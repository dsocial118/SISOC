...
class CentroDeleteView(LoginRequiredMixin, DeleteView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        centro.save()
        messages.success(request, f"El centro '{centro.nombre}' fue desactivado correctamente.")
...
class CentroListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        if self.request.user.groups.filter(name="ReferenteCentro").exists() and not self.request.user.is_superuser:
