...
class Centro(models.Model):
    ...
    faro_asociado = models.ForeignKey('self', null=True, blank=True, on_delete=models.SET_NULL, limit_choices_to={'tipo': 'faro', 'activo': True})
...
class ParticipanteActividad(models.Model):
    actividad_centro = models.ForeignKey('ActividadCentro', on_delete=models.CASCADE, verbose_name="Actividad del Centro")
    nombre = models.CharField(max_length=100, verbose_name="Nombre")
    apellido = models.CharField(max_length=100, verbose_name="Apellido")
    dni = models.CharField(max_length=15, verbose_name="DNI")
    genero = models.CharField(max_length=20, choices=[('masculino', 'Masculino'), ('femenino', 'Femenino'), ('otro', 'Otro')], verbose_name="Género")
