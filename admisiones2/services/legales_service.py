...
class LegalesService:
    ...
    def guardar_convenio_num_if(request, admision):
        try:
            formulario = admision.admisiones2_proyecto_convenio.first()
    ...
    def guardar_dispo_num_if(request, admision):
        try:
            formulario = admision.admisiones2_proyecto_disposicion.first()
            if formulario is None:
    ...
    def guardar_formulario_reso(request, admision):
        try:
            ...
            pdf_template_name = (
                "admisiones2/pdf_dispo_incorporacion.html"
                if nuevo_formulario.tipo == "incorporacion"
                else "admisiones2/pdf_dispo_renovacion.html"
            )
    ...
    def guardar_formulario_proyecto_convenio(request, admision):
        try:
            ...
            pdf_template_name = "admisiones2/pdf_convenio.html"
            docx_template_name = "admisiones2/docx_convenio.html"
    ...
    def get_legales_context(admision):
        try:
            ...
            reso_formulario = admision.admisiones2_proyecto_disposicion.first()
            proyecto_formulario = admision.admisiones2_proyecto_convenio.first()
