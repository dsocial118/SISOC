...
class CDIF_PreAdmision(models.Model):
    ...
    planes_sociales_1 = models.ForeignKey(
        PlanesSociales,
        related_name="planes_sociales_1",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    ...
    planes_sociales_2 = models.ForeignKey(
        PlanesSociales,
        related_name="planes_sociales_2",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    ...
    centro_postula = models.ForeignKey(
        Vacantes, on_delete=models.CASCADE, null=False, blank=False
    )
    sala_postula = models.CharField(
        max_length=150, choices=CHOICE_SALA_POSTULA, null=False, blank=False
    )
    turno_postula = models.CharField(
        max_length=150, choices=CHOICE_TURNO_POSTULA, null=False, blank=False
    )
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="PreAdm_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="PreAdm_modificado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class CDIF_IndiceIVI(models.Model):
    ...
    fk_preadmi = models.ForeignKey(
        CDIF_PreAdmision, on_delete=models.CASCADE, null=True, blank=True
    )
...
class CDIF_Foto_IVI(models.Model):
    ...
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="IVI_modificado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class CDIF_Vacantes(models.Model):
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="Vacante_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="Vacante_modificada_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class CDIF_Admision(models.Model):
    fk_preadmi = models.ForeignKey(CDIF_PreAdmision, on_delete=models.CASCADE)
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="Admision_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="Admision_modificada_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class CDIF_VacantesOtorgadas(models.Model):
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="VacanteOtorgada_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="VacanteOtorgada_modificada_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class CDIF_HistorialVacantes(models.Model):
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="HistorialVacantes_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="HistorialVacantes_modificada_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class CDIF_Intervenciones(models.Model):
    fk_admision = models.ForeignKey(
        CDIF_Admision, on_delete=models.CASCADE, null=True, blank=True
    )
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="Intervenciones_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="Intervenciones_modificada_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
