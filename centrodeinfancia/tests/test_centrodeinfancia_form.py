...
def test_form_filtra_departamentos_por_provincia():
    ...
    form = CentroDeInfanciaForm(data={"nombre": "CDI Norte", "provincia": provincia_ba.id})

    departamento_ids = set(form.fields["departamento"].queryset.values_list("id", flat=True))
