...
from .models import (Accion, ActividadRealizada, Agua, AportesJubilacion,
                     AreaCurso, AsisteEscuela, CantidadAmbientes, CentrosSalud,
                     CondicionDe, ContextoCasa, Desague, DuracionTrabajo,
                     EstadoCivil, EstadoDerivacion, EstadoEducativo,
                     EstadoIntervencion, EstadoLlamado, EstadoNivelEducativo,
                     EstadoRelacion, Frecuencia, Gas, Genero, GeneroPronombre,
                     Grado, Importancia, Inodoro, LegajoLocalidad,
                     LegajoMunicipio, LegajoProvincias, ModoContratacion,
                     MotivoNivelIncompleto, Nacionalidad, Nivel,
                     NivelEducativo, NoBusquedaLaboral, Rechazo, Sexo,
                     TiempoBusquedaLaboral, TipoAyudaHogar,
                     TipoConstruccionVivienda, TipoDiscapacidad, TipoDoc,
                     TipoEnfermedad, TipoEstadoVivienda, TipoGestion,
                     TipoPisosVivienda, TipoPosesionVivienda,
                     TipoTechoVivienda, TipoVivienda, Turno, VinculoFamiliar)
