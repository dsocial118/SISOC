# Generated by Django 4.2.16 on 2025-04-06 18:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="hist_legajo_programa",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="ciudadanos.tiempobusqueda_laboral",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="ciudadanos.nobusqueda_laboral",
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to="ciudadanos.categoriaalertas"
                    ),
                ),
                (
                    "estado",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="ciudadanos.categoriaalertas",
            ),
        ),
        migrations.CreateModel(
            name="Llamado",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["legajo"], name="ciudadanos__legajo__631726_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["legajo"], name="ciudadanos__legajo__4755e5_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["legajo"], name="ciudadanos__legajo__ee9b22_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["legajo_1Hogar"], name="ciudadanos__legajo__572548_idx"
                    ),
                    models.Index(
                        fields=["legajo_2Hogar"], name="ciudadanos__legajo__fa7cc3_idx"
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["legajo_1_id"], name="ciudadanos__legajo__6a9e96_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="grupofamiliar",
            index=models.Index(
                fields=["legajo_2_id"], name="ciudadanos__legajo__76d5cf_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["legajo"], name="ciudadanos__legajo__e1a82e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dimensiontrabajo",
            index=models.Index(
                fields=["legajo"], name="ciudadanos__legajo__2297ea_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dimensionsalud",
            index=models.Index(
                fields=["legajo"], name="ciudadanos__legajo__c34d1d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dimensioneducacion",
            index=models.Index(
                fields=["legajo"], name="ciudadanos__legajo__aeaee8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dimensioneconomia",
            index=models.Index(
                fields=["legajo"], name="ciudadanos__legajo__2f87cb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="derivacion",
            index=models.Index(
                fields=["legajo"], name="ciudadanos__legajo__6c58d1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="derivacion",
        ...
        migrations.AddIndex(
            model_name="archivo",
            index=models.Index(
                fields=["legajo"], name="ciudadanos__legajo__6635ca_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="alerta",
