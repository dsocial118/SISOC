...
def convert_to_boolean(value) -> bool:
    ...
    try:
        ...
        raise ValueError(f"Valor inesperado para booleano: {value} (tipo: {type(value)})")
        
    except (KeyError, AttributeError) as exc:
        raise ValueError(f"Valor inesperado para booleano: {value} (tipo: {type(value)})") from exc
