...
urlpatterns = [
    path(
        ...
        permissions_any_required(["Comedores Relevamiento Ver"])(RelevamientoListView.as_view()),
        name="relevamientos",
    ),
    path(
        "comedores/<comedor_pk>/relevamiento/crear",
        permissions_any_required(["Comedores Relevamiento Crear"])(
    ...
    path(
        ...
        permissions_any_required(["Comedores Relevamiento Detalle"])(
    ...
    path(
        ...
        permissions_any_required(["Comedores Relevamiento Editar"])(
