...
def format_estado(value):
    ...
    estados_map = {
        ...
        "Formulario Primera Providencia Creado": "Formulario Primera Providencia Creado",
        "IF Primera Providencia Asignado": "IF Primera Providencia Asignado",
        "Formulario Segunda Providencia Creado": "Formulario Segunda Providencia Creado",
