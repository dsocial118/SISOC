...
from ..models.admisiones import ArchivoAdmision, InformeTecnico, FormularioProyectoDeConvenio, FormularioProyectoDisposicion
...
class DocumentTemplateService:
    ...
    def generar_pdf(template_name, context, app_name='admisiones'):
        ...
        clean_context = DocumentTemplateService._sanear_contexto(context, campos_sin_escape=["informe", "texto_comidas", "html_content"])
    ...
    def preparar_contexto_informe_tecnico(informe):
        ...
        for key, value in texto_comidas_raw.items():
            if isinstance(value, str):
                texto_comidas_clean[key] = TextFormatterService.formatear_texto_comida_docx(value)
            else:
...
class TextFormatterService:
    ...
    def formatear_texto_comida_docx(texto_html):
        ...
        for match in matches:
            ...
            cantidad_palabra = TextFormatterService.NUMEROS_PALABRAS.get(cantidad_num, cantidad_num)
            veces_palabra = TextFormatterService.NUMEROS_PALABRAS.get(veces_num, veces_num)
