    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_Admision_creado_por', to='Usuarios.usuarios')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acompaniante', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_Acompaniante', to='Usuarios.usuarios')),
                ('creado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_PreAdm_creado_por', to='Usuarios.usuarios')),
                ('fk_derivacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Legajos.legajosderivaciones')),
                ('fk_legajo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_fk_legajo', to='Legajos.legajos')),
                ('fk_legajo_1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_fk_legajo_1', to='Legajos.legajos')),
                ('fk_legajo_2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_fk_legajo_2', to='Legajos.legajos')),
                ('fk_legajo_3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_fk_legajo_3', to='Legajos.legajos')),
                ('fk_legajo_4', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_fk_legajo_4', to='Legajos.legajos')),
                ('fk_legajo_5', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_fk_legajo_5', to='Legajos.legajos')),
                ('madrina', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_Madrina', to='Configuraciones.agentesexternos')),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_PreAdm_modificado_por', to='Usuarios.usuarios')),
                ('planes_sociales_1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_planes_sociales_1', to='Configuraciones.planessociales')),
                ('planes_sociales_2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_planes_sociales_2', to='Configuraciones.planessociales')),
            ],
        ),
        migrations.CreateModel(
            name='CDLE_Intervenciones',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('creado', models.DateField(auto_now_add=True, null=True)),
                ('modificado', models.DateField(auto_now=True, null=True)),
                ('creado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_Intervenciones_creado_por', to='Usuarios.usuarios')),
                ('criterio_modificable', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SIF_CDLE.criterios_ivi')),
                ('fk_admision', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SIF_CDLE.cdle_admision')),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_Intervenciones_modificada_por', to='Usuarios.usuarios')),
                ('responsable', models.ManyToManyField(to='SIF_CDLE.OpcionesResponsables')),
            ],
        ),
        migrations.CreateModel(
            name='CDLE_IndiceIVI',
            fields=[
                ...
                ('creado', models.DateField(auto_now_add=True, null=True)),
                ('modificado', models.DateField(auto_now=True, null=True)),
                ('fk_criterios_ivi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SIF_CDLE.criterios_ivi')),
                ('fk_legajo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Legajos.legajos')),
                ('fk_preadmi', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SIF_CDLE.cdle_preadmision')),
            ],
        ),
        migrations.CreateModel(
            name='CDLE_IndiceIngreso',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('presencia', models.BooleanField(blank=True, default=False, null=True)),
                ('tipo', models.CharField(blank=True, max_length=350, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creado', models.DateField(auto_now_add=True, null=True)),
                ('modificado', models.DateField(auto_now=True, null=True)),
                ('creado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_IVI_creado_por', to='Usuarios.usuarios')),
                ('fk_legajo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Legajos.legajos')),
                ('fk_preadmi', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SIF_CDLE.cdle_preadmision')),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_IVI_modificado_por', to='Usuarios.usuarios')),
            ],
        ),
        migrations.CreateModel(
            name='CDLE_Foto_Ingreso',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('puntaje', models.SmallIntegerField(blank=True, null=True)),
                ('puntaje_max', models.SmallIntegerField(blank=True, null=True)),
                ...
                ('creado', models.DateField(auto_now_add=True, null=True)),
                ('modificado', models.DateField(auto_now=True, null=True)),
                ('creado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_Ingreso_creado_por', to='Usuarios.usuarios')),
                ('fk_legajo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Legajos.legajos')),
                ('fk_preadmi', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SIF_CDLE.cdle_preadmision')),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_Ingreso_modificado_por', to='Usuarios.usuarios')),
            ],
        ),
        migrations.AddField(
            model_name='cdle_admision',
            name='fk_preadmi',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SIF_CDLE.cdle_preadmision'),
        ),
        migrations.AddField(
            model_name='cdle_admision',
            name='modificado_por',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CDLE_Admision_modificada_por', to='Usuarios.usuarios'),
        ),
    ]
