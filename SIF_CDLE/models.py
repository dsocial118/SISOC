...
class CDLE_PreAdmision(models.Model):
    ...
    planes_sociales_1 = models.ForeignKey(
        PlanesSociales,
        related_name="CDLE_planes_sociales_1",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    ...
    planes_sociales_2 = models.ForeignKey(
        PlanesSociales,
        related_name="CDLE_planes_sociales_2",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    ...
    centro_controla = models.CharField(
        max_length=250,
        verbose_name="Centro de salud que se controla",
        null=True,
        blank=True,
    ...
    acompaniante = models.ForeignKey(
        Usuarios,
        related_name="CDLE_Acompaniante",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="CDLE_PreAdm_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="CDLE_PreAdm_modificado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class CDLE_IndiceIVI(models.Model):
    ...
    fk_preadmi = models.ForeignKey(
        CDLE_PreAdmision, on_delete=models.CASCADE, null=True, blank=True
    )
...
class CDLE_Foto_IVI(models.Model):
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="CDLE_IVI_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="CDLE_IVI_modificado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class CDLE_Foto_Ingreso(models.Model):
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="CDLE_Ingreso_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="CDLE_Ingreso_modificado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class CDLE_Admision(models.Model):
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="CDLE_Admision_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="CDLE_Admision_modificada_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class CDLE_Intervenciones(models.Model):
    fk_admision = models.ForeignKey(
        CDLE_Admision, on_delete=models.CASCADE, null=True, blank=True
    )
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="CDLE_Intervenciones_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="CDLE_Intervenciones_modificada_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
