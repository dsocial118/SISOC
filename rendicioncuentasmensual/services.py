...
class RendicionCuentaMensualService:
    ...
    @staticmethod
    def aplicar_usuario_ultima_modificacion(rendicion, actor):
        """Registra el último actor para servicios externos al flujo base."""
    ...
    @staticmethod
    def documentos_vigentes_queryset(rendicion):
        """Expone los documentos vigentes para servicios de proceso."""
        return RendicionCuentaMensualService._documentos_vigentes_queryset(rendicion)
