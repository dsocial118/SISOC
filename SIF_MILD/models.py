...
class MILD_PreAdmision (models.Model):
    ...
    planes_sociales_1 = models.ForeignKey(PlanesSociales, related_name='MILD_planes_sociales_1', on_delete=models.CASCADE, null=True, blank=True)
    ...
    planes_sociales_2 = models.ForeignKey(PlanesSociales, related_name='MILD_planes_sociales_2', on_delete=models.CASCADE, null=True, blank=True)
    ...
    fk_legajo_3 = models.ForeignKey(Legajos, related_name='MILD_fk_legajo_3', on_delete=models.CASCADE, null=True, blank=True)
    ...
    fk_legajo_4 = models.ForeignKey(Legajos, related_name='MILD_fk_legajo_4', on_delete=models.CASCADE, null=True, blank=True)
    ...
    fk_legajo_5 = models.ForeignKey(Legajos, related_name='MILD_fk_legajo_5', on_delete=models.CASCADE, null=True, blank=True)
    ...
    cri_sanitarios = models.CharField(max_length=250, choices=CHOICE_CRI_SANITARIOS, null=True, blank=True, verbose_name='Criterios sanitarios')
    cri_sociales = models.CharField(max_length=250, choices=CHOICE_CRI_SOCIALES, null=True, blank=True, verbose_name='Criterios sociales')
    busca_embarazo = models.BooleanField(verbose_name='¿Está buscando quedarse embarazada?', null=True, blank=True)
    conoce_metodos_anticon = models.BooleanField(verbose_name='¿Conoces qué son los métodos anticonceptivos?', null=True, blank=True)
    metodos_anticon = models.CharField(max_length=250, choices=CHOICE_METODOS_ANTICONCEPTIVOS, null=True, blank=True, verbose_name='¿Cuáles conoces?')
    utilizo_alguno = models.BooleanField(verbose_name='¿Utilizás alguno actualmente?', null=True, blank=True)
    cual_utilizo = models.CharField(max_length=250, choices=CHOICE_METODOS_ANTICONCEPTIVOS, null=True, blank=True, verbose_name='¿Cuáles utilizó?')
    amigos_cercanos = models.BooleanField(verbose_name='¿Tenés amigos, personas cercanas o alguien con quien hablar problema?', null=True, blank=True)

    apellido_ninio = models.CharField(max_length=250, null=True, blank=True, verbose_name='Apellido')
    nombre_ninio = models.CharField(max_length=250, null=True, blank=True, verbose_name='Nombre')
    dni_num_ninio = models.IntegerField(null=True, blank=True, verbose_name='Número DNI')
    dni_ninio = models.CharField(max_length=250, choices=CHOICE_DNI_NINIO, null=True, blank=True, verbose_name='DNI')
    sexo_ninio = models.CharField(max_length=250, choices=CHOICE_SEXO_NINIO, null=True, blank=True, verbose_name='Sexo')
    edad_ninio = models.IntegerField(null=True, blank=True, verbose_name='Edad')
    fecha_nacimiento = models.DateField(null=True, blank=True, verbose_name='Fecha de nacimiento')
    lugar_nacimiento = models.CharField(max_length=250, null=True, blank=True, verbose_name='Lugar de nacimiento')
    peso_ninio = models.IntegerField(null=True, blank=True, verbose_name='Peso al nacer')
    mismo_domicilio = models.BooleanField(verbose_name='Mismo domicilio y teléfono que el cuidador entrevistado?', null=True, blank=True)
    ...
    enf_recu_sin_trata = models.BooleanField(verbose_name='Padece enfermedad recurrente SIN tratamiento', null=True, blank=True)
    enf_conta_con_trata = models.BooleanField(verbose_name='Padece enfermedad infecto-contagiosa EN tratamiento', null=True, blank=True)
    enf_conta_sin_trata = models.BooleanField(verbose_name='Padece enfermedad infecto-contagiosa SIN tratamiento', null=True, blank=True)
    enf_mental_con_trata = models.BooleanField(verbose_name='Padece problemas de salud mental EN tratamiento', null=True, blank=True)
    enf_mental_sin_trata = models.BooleanField(verbose_name='Padece problemas de salud mental SIN tratamiento', null=True, blank=True)
    capa_reducidas = models.BooleanField(verbose_name='Capacidades reducidas o afectadas', null=True, blank=True)
    certif_discap = models.BooleanField(verbose_name='Tiene certificado único de discapacidad', null=True, blank=True)
    medicamento = models.BooleanField(verbose_name='Toma medicamento', null=True, blank=True)
    bajo_peso = models.BooleanField(verbose_name='Niño con bajo peso', null=True, blank=True)
    sobrepeso = models.BooleanField(verbose_name='Niño con sobrepeso', null=True, blank=True)
    prematuro = models.BooleanField(verbose_name='Prematuro que requiere seguimiento', null=True, blank=True)
    interv_quirurgicas = models.BooleanField(verbose_name='Intervenciones quirúrgicas', null=True, blank=True)
    accidentes_domesticos = models.BooleanField(verbose_name='Accidentes domésticos (lastimadura, quemadura, corte, golpe fuerte)', null=True, blank=True)
    colecho = models.BooleanField(verbose_name='Colecho', null=True, blank=True)
    enfermedad = models.CharField(max_length=250, null=True, blank=True, verbose_name='Si padece enfermedad ¿cuál? ¿Dónde se trata?')
    auditiva = models.BooleanField(verbose_name='Dificultad auditiva', null=True, blank=True)
    respiratoria = models.BooleanField(verbose_name='Dificultad respiratoria', null=True, blank=True)
    visual = models.BooleanField(verbose_name='Dificultad visual', null=True, blank=True)
    traumatologica = models.BooleanField(verbose_name='Dificultad traumatologica', null=True, blank=True)
    emocional = models.BooleanField(verbose_name='Dificultad emocional', null=True, blank=True)
    psiquica = models.BooleanField(verbose_name='Dificultad psiquica o psicologica', null=True, blank=True)
    digestiva = models.BooleanField(verbose_name='Dificultad digestiva', null=True, blank=True)
...
class MILD_IndiceIVI(models.Model):
    ...
    fk_preadmi = models.ForeignKey(MILD_PreAdmision, on_delete=models.CASCADE, null=True, blank=True)
...
class MILD_Intervenciones(models.Model):
    fk_admision = models.ForeignKey(MILD_Admision, on_delete=models.CASCADE, null=True, blank=True)
