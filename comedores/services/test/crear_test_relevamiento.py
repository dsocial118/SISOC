...
def crear_test_relevamiento(sisoc_id,
        gestionar_uid,
        relevador,
        estado,
        fecha_visita,
    ...
    def create_tipo_recurso(nombre):
        """Crea un TipoRecurso solo si el nombre no está vacío."""
        if nombre:
            return TipoRecurso.objects.create(nombre=nombre)
        # Buscar el último objeto con nombre vacío
        return TipoRecurso.objects.filter(nombre="").last() or TipoRecurso.objects.create(nombre="")
    
    espacio_abastecimiento_agua = TipoAgua.objects.create(nombre=espacio["cocina"]["abastecimiento_agua"])
    espacio_prestacio_frecuencia_limpieza = FrecuenciaLimpieza.objects.create(nombre=espacio["prestacion"]["frecuencia_limpieza"])
    ...
    recursos_tipo_recursos_donaciones_particulares = create_tipo_recurso(recursos["recursos_donaciones_particulares"])
    recursos_tipo_recursos_estado_nacional = create_tipo_recurso(recursos["recursos_estado_nacional"])
    recursos_tipo_recursos_estado_provincial = create_tipo_recurso(recursos["recursos_estado_provincial"])
    recursos_tipo_recursos_estado_municipal = create_tipo_recurso(recursos["recursos_estado_municipal"])
    ...
    fuente_recursos.recursos_donaciones_particulares.set([recursos_tipo_recursos_donaciones_particulares])
    fuente_recursos.recursos_estado_nacional.set([recursos_tipo_recursos_estado_nacional])
    fuente_recursos.recursos_estado_provincial.set([recursos_tipo_recursos_estado_provincial])
    fuente_recursos.recursos_estado_municipal.set([recursos_tipo_recursos_estado_municipal])
    fuente_recursos.recursos_otros.set([recursos_tipo_recursos_otros])

    punto_de_entrega = PuntoEntregas.objects.create(
            tipo_comedor= TipoDeComedor.objects.create(nombre=punto_entregas["tipo_comedor"]),
            reciben_otros_recepcion=punto_entregas["reciben_otros_recepcion"],
            frecuencia_entrega_bolsones=frecuencia_tipo_bolsones,
            tipo_modulo_bolsones=TipoModuloBolsones.objects.create(nombre=punto_entregas["tipo_modulo_bolsones"]),
            ...
            retiran_mercaderias_distribucion=punto_entregas["retiran_mercaderias_distribucion"],
    ...
    espacio_cocina = EspacioCocina.objects.create(
        espacio_elaboracion_alimentos=espacio["cocina"]["espacio_elaboracion_alimentos"],
        almacenamiento_alimentos_secos=espacio["cocina"]["almacenamiento_alimentos_secos"],
        heladera=espacio["cocina"]["heladera"],
        freezer=espacio["cocina"]["freezer"],
        recipiente_residuos_organicos=espacio["cocina"]["recipiente_residuos_organicos"],
        recipiente_residuos_reciclables=espacio["cocina"]["recipiente_residuos_reciclables"],
    ...
    tipo_combustible = TipoCombustible.objects.create(nombre=espacio["cocina"]["abastecimiento_combustible"])
    ...
    espacio_prestacion = EspacioPrestacion.objects.create(
        ...
        salida_emergencia_senializada=espacio["prestacion"]["salida_emergencia_senializada"],
        ...
        desague_hinodoro=TipoDesague.objects.create(nombre=espacio["prestacion"]["desague_hinodoro"]),
        gestion_quejas=TipoGestionQuejas.objects.create(nombre=espacio["prestacion"]["gestion_quejas"]),
    ...
    espacio_tipo_espacio_fisico = TipoEspacio.objects.create(nombre=espacio["tipo_espacio_fisico"])
    ...
    relevamiento = Relevamiento.objects.create(
        ...
        funcionamiento=FuncionamientoPrestacion.objects.create(
            modalidad_prestacion=TipoModalidadPrestacion.objects.create(nombre=funcionamiento["modalidad_prestacion"]),
        ...
        colaboradores=Colaboradores.objects.create(
            ...
            colaboradores_capacitados_alimentos=colaboradores_json["colaboradores_capacitados_alimentos"],
            colaboradores_recibieron_capacitacion_alimentos=colaboradores_json["colaboradores_recibieron_capacitacion_alimentos"],
            colaboradores_capacitados_salud_seguridad=colaboradores_json["colaboradores_capacitados_salud_seguridad"],
            colaboradores_recibieron_capacitacion_emergencias=colaboradores_json["colaboradores_recibieron_capacitacion_emergencias"],
            colaboradores_recibieron_capacitacion_violencia=colaboradores_json["colaboradores_recibieron_capacitacion_violencia"],
        ),
