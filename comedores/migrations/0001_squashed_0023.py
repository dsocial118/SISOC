...
def _map_legacy_nombre(nombre):
    ...
    if normalized in {"pendiente", "pendientes"} or "pend" in normalized:
        return "pendiente"
    if (
        normalized in {"activo", "activos"}
        or "act" in normalized
        or "habil" in normalized
    ):
        return "activo"
    if (
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="territorialcache",
            index=models.Index(
                fields=["provincia", "activo"], name="comedores_t_provinc_38a553_idx"
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Fecha de validación"
                    ),
                ),
                (
                    "comedor",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["comedor", "fecha_validacion"],
                        name="comedores_h_comedor_86d7a4_idx",
                    )
                ],
            },
        ),
