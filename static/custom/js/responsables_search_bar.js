(function () {
    /**
     * Responsables Search Bar (filtros combinables)
     * Reutiliza la logica de beneficiarios con campos propios.
     */
    const TEXT_FIELDS = [
        ...
        { value: 'prefijo_celular', label: 'Prefijo celular' },
        { value: 'numero_celular', label: 'Numero celular' },
        { value: 'prefijo_telefono_fijo', label: 'Prefijo telefono fijo' },
        { value: 'numero_telefono_fijo', label: 'Numero telefono fijo' },
