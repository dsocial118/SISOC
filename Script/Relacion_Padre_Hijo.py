...
def main():
    ...
    engine_pas_padron_01_05_2024 = create_engine('mysql://root:REDACTED@localhost:3306/pas_padron_01_05_2024')  # Cambia con tu URL de base de datos
    engine_hsu_dev = create_engine('mysql://root:REDACTED@localhost:3306/hsu-dev')  # Cambia con tu URL de base de datos
    ...
    query = """
        SELECT
            ...
            bp.nacionalidad, null AS ESTADO_CIVIL, bp.calle, bp.torrepasillo, bp.escaleramanzana, bp.numero AS ALTURA, bp.pisodpto, null AS CIRCUITO,
            bp.barrio, bp.localidad,bp.codigopostal, bp.telefono, bp.email, null AS FOTO,
