...
- Archivos visuales relevantes: centrodeinfancia/templates/centrodeinfancia/generar_usuario_egp.html, centrodeinfancia/templates/centrodeinfancia/usuario_egp_generado.html, templates/includes/sidebar/opciones.html
...
- `centrodeinfancia/sidebar_access.py`
...
- `docs/ia/TESTING.md`
- `docs/contexto/features/pr-2373-fix-cdi-correcciones-bloqueantes-issue-2369.md`
- `docs/registro/2026-08-28-issue-2369-correcciones-cdi.md`
- `docs/registro/prs/PR-2373.md`
