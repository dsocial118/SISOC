# Contexto de feature PR #2538 - revert: restaurar en development las features pospuestas del release 2026-09-16

## Resumen

- PR: https://github.com/dsocial118/SISOC/pull/2538
- Base: `development`
- Rama origen: `fix/restaurar-features-pospuestas`
- Autor: `juanikitro`
...
- Empezar por `docs/registro/prs/PR-2538.md` para contexto resumido del PR.
...
- ... y 68 archivo(s) adicional(es) relacionados.
