# Contexto de feature PR #2383 - chore(sync): integrar main en homologacion

## Resumen

- PR: https://github.com/dsocial118/SISOC/pull/2383
- Base: `homologacion`
...
- Empezar por `docs/registro/prs/PR-2383.md` para contexto resumido del PR.
