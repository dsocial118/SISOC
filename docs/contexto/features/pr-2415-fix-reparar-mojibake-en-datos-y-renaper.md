# Contexto de feature PR #2415 - fix: reparar mojibake en datos y RENAPER

## Resumen

- PR: https://github.com/dsocial118/SISOC/pull/2415
- Base: `main`
- Rama origen: `codex/fix-mojibake-datos`
- Autor: `juanikitro`
...
- Empezar por `docs/registro/prs/PR-2415.md` para contexto resumido del PR.
