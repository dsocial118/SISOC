# Contexto de feature PR #2387 - chore(sync): integrar main en development

## Resumen

- PR: https://github.com/dsocial118/SISOC/pull/2387
- Base: `development`
...
- Empezar por `docs/registro/prs/PR-2387.md` para contexto resumido del PR.
- Revisar primero estos archivos del diff:
- `CHANGELOG.md`
- `comedores/api_views_territorial.py`
- `docs/contexto/features/pr-2382-chore-sync-integrar-main-en-development.md`
- `docs/contexto/features/pr-2386-fix-relevamientos-feedback-qa-territoriales-visibilidad-finalizar-estados-permisos.md`
- `docs/registro/prs/PR-2382.md`
