# Contexto de feature PR #2536 - chore(sync): integrar main en development
...
- Empezar por `docs/registro/prs/PR-2536.md` para contexto resumido del PR.
...
- ... y 75 archivo(s) adicional(es) relacionados.
