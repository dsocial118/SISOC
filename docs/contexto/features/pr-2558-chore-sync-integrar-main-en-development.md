# Contexto de feature PR #2558 - chore(sync): integrar main en development
...
- Empezar por `docs/registro/prs/PR-2558.md` para contexto resumido del PR.
...
- ... y 22 archivo(s) adicional(es) relacionados.
