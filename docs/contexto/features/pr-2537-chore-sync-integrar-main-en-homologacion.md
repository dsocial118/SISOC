# Contexto de feature PR #2537 - chore(sync): integrar main en homologacion

## Resumen

- PR: https://github.com/dsocial118/SISOC/pull/2537
- Base: `homologacion`
...
- Empezar por `docs/registro/prs/PR-2537.md` para contexto resumido del PR.
