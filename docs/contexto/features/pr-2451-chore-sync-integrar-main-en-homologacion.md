# Contexto de feature PR #2451 - chore(sync): integrar main en homologacion

## Resumen

- PR: https://github.com/dsocial118/SISOC/pull/2451
- Base: `homologacion`
...
- Empezar por `docs/registro/prs/PR-2451.md` para contexto resumido del PR.
