# Contexto de feature PR #2405 - fix(centrodeinfancia): precargar provincia del CDI

## Resumen

- PR: https://github.com/dsocial118/SISOC/pull/2405
- Base: `homologacion`
- Rama origen: `codex/cdi-default-provincia-hml`
- Autor: `juanikitro`
...
- Empezar por `docs/registro/prs/PR-2405.md` para contexto resumido del PR.
