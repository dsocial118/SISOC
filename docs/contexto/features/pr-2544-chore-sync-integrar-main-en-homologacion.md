# Contexto de feature PR #2544 - chore(sync): integrar main en homologacion

## Resumen

- PR: https://github.com/dsocial118/SISOC/pull/2544
- Base: `homologacion`
...
- Empezar por `docs/registro/prs/PR-2544.md` para contexto resumido del PR.
