# Contexto de feature PR #2526 - chore(sync): integrar main en homologacion

## Resumen

- PR: https://github.com/dsocial118/SISOC/pull/2526
- Base: `homologacion`
...
- Empezar por `docs/registro/prs/PR-2526.md` para contexto resumido del PR.
