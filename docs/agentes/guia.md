...
- Registro obligatorio de trabajo importante: documentar cada cambio o decisión importante en `docs/` usando la subcarpeta temática que corresponda (crearla si no existe).
