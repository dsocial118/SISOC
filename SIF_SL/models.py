...
class SL_PreAdmision(models.Model):
    ...
    planes_sociales_1 = models.ForeignKey(
        PlanesSociales,
        related_name="SL_planes_sociales_1",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    ...
    planes_sociales_2 = models.ForeignKey(
        PlanesSociales,
        related_name="SL_planes_sociales_2",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    ...
    expediente_nro = models.CharField(
        max_length=150,
        null=False,
        blank=False,
    ...
    tipo_organismo = models.CharField(
        max_length=150,
        choices=CHOICE_TIPO_ORGANISMO,
        null=True,
        blank=True,
        verbose_name="Tipo de organismo",
    )
    vulneracion = models.CharField(
        max_length=150,
        choices=CHOICE_VULNERACION,
        null=True,
        blank=True,
        verbose_name="Vulneración",
    )
    obs_vulneracion = models.CharField(
        max_length=800,
        null=True,
        blank=True,
        verbose_name="Observaciones de vulneración",
    )
    dinamica_familiar = models.CharField(
        max_length=800, null=True, blank=True, verbose_name="Dinamica familiar"
    )

    acompaniante = models.ForeignKey(
        Usuarios,
        related_name="SL_Acompaniante",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="SL_PreAdm_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="SL_PreAdm_modificado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class SL_IndiceIVI(models.Model):
    ...
    fk_preadmi = models.ForeignKey(
        SL_PreAdmision, on_delete=models.CASCADE, null=True, blank=True
    )
...
class SL_Foto_IVI(models.Model):
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="SL_IVI_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="SL_IVI_modificado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class SL_Foto_Ingreso(models.Model):
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="SL_Ingreso_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="SL_Ingreso_modificado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class SL_Admision(models.Model):
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="SL_Admision_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="SL_Admision_modificada_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class SL_Intervenciones(models.Model):
    fk_admision = models.ForeignKey(
        SL_Admision, on_delete=models.CASCADE, null=True, blank=True
    )
    ...
    creado_por = models.ForeignKey(
        Usuarios,
        related_name="SL_Intervenciones_creado_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    modificado_por = models.ForeignKey(
        Usuarios,
        related_name="SL_Intervenciones_modificada_por",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
