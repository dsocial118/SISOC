    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expediente_nro",
                    models.CharField(
                        default=".", max_length=150, verbose_name="Número de expediente"
                    ),
                ),
                (
                    "tipo_organismo",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (
                                "Riesgo habitacional/salud/alimenticio",
                                "Riesgo habitacional/salud/alimenticio",
                            ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=800,
                        null=True,
                        verbose_name="Dinamica familiar",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "responsable",
                    models.ManyToManyField(to="SIF_SL.OpcionesResponsables"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="SIF_SL.sl_preadmision"
            ),
        ),
        migrations.AddField(
            model_name="sl_admision",
