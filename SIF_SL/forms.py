...
class SL_PreadmisionesForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "obs_vulneracion": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 3,
                }
            ),
            "dinamica_familiar": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 3,
                }
...
class SL_IndiceIngresoForm(forms.ModelForm):
    class Meta:
        model = SL_IndiceIngreso
        fields = "__all__"
        widgets = {}
        labels = {}


class SL_IndiceIngresoHistorialForm(forms.ModelForm):
    class Meta:
        model = SL_Foto_Ingreso
        fields = "__all__"
        widgets = {}
        labels = {}
...
class SL_IndiceIviForm(forms.ModelForm):
    class Meta:
        model = SL_IndiceIVI
        fields = "__all__"
        widgets = {}
...
class SL_IndiceIviHistorialForm(forms.ModelForm):
    class Meta:
        model = SL_Foto_IVI
        fields = "__all__"
        widgets = {}
